...
class MinutesXAxisValueFormatter: NSObject, IAxisValueFormatter {
    ...
    private func dayInYear(for minute: Double) -> Int {
        return Int(minute / ( 24.0 * 60 ))
    }
    ...
    private func minuteInDay(for minuteInYear: Double) -> Int {
        return Int(minuteInYear) % (24 * 60)
    }
